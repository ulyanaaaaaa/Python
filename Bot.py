...
bot = telebot.TeleBot('6618050034:AAFT9jITWmmD0nEQyZQik-gesKFjvumkteg')
...
def get_text_messages(message):
    if message.text == "Привет":
        ...
        key_oven = types.InlineKeyboardButton(text='Овен', callback_data='zodiac') #создание кнопки
        keyboard.add(key_oven)  #добавление кнопки на экран
